...
import static io.metersphere.platform.domain.oss.RequestParameters.OSS_TRAFFIC_LIMIT;
import static io.metersphere.platform.domain.oss.SignParameters.AUTHORIZATION_PREFIX;
